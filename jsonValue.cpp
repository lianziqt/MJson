	...
	namespace json {
        ...
        void Value::init(const Value& rhs) {
            ...
            case json::TYPE_STRING:
                ...
                break;
            case json::TYPE_ARRAY: new(&arr_) std::vector<Value>(rhs.arr_);
                break;
            case json::TYPE_OBJECT: new(&obj_) json::objValue(rhs.obj_);
                break;
            }
        ...
        void Value::free() {
            ...
            case json::TYPE_STRING:
                ...
                //if (str_ != nullptr) delete str_;
                break;
            case json::TYPE_ARRAY: arr_.~vector<Value>();
                break;
            case json::TYPE_OBJECT: obj_.~vector<std::pair<std::string, Value>>();
                break;
            }
        }
